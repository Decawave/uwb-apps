...
1. To erase the default flash image that shipped with the DWM1002.
...
2. On the dwm1001-dev board build the TDMA node (twr_node_tdma) applicaitons for the DWM1001 module. 
