...
int json_ftype_encode(ss_twr_frame_t * frame){
    ...
    JSON_VALUE_UINT(&value, frame->response.fctrl);
    rc |= json_encode_object_entry(&encoder, "fctrl", &value);
    JSON_VALUE_UINT(&value, frame->response.seq_num);
    rc |= json_encode_object_entry(&encoder, "seq_num", &value);
    JSON_VALUE_UINT(&value, frame->response.PANID);
    rc |= json_encode_object_entry(&encoder, "PANID", &value);
    JSON_VALUE_UINT(&value, frame->response.dst_address);
    rc |= json_encode_object_entry(&encoder, "dst_address", &value);
    JSON_VALUE_UINT(&value, frame->response.src_address);
    rc |= json_encode_object_entry(&encoder, "src_address", &value);
    JSON_VALUE_UINT(&value, frame->response.code);
    rc |= json_encode_object_entry(&encoder, "code", &value);
    JSON_VALUE_UINT(&value, frame->response.reception_timestamp);
    rc |= json_encode_object_entry(&encoder, "reception_timestamp", &value);
    JSON_VALUE_UINT(&value, frame->response.transmission_timestamp);
